...
$peso_libras=$cantidad_piezas=$recepcion=$id_cliente=$id_empresa=0;
 ...
 if( $objDatos->peso_libras != NULL)
 {
     ...
     /*se agrega tipo_orden para la tabla orden_servicios*/
     $tipo_orden = $objDatos->tipo_orden;
    ...
    $query="INSERT INTO orden_servicios(peso_libras,cantidad_piezas,recepcion,id_cliente, id_empresa, precio_orden, id_servicio)  VALUES ('$peso_libras', '$cantidad_piezas', '$recepcion', '$id_cliente', '$id_empresa', '$precio', '$tipo_orden')";
